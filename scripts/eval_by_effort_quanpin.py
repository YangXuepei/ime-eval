...
def eval_layout_LUTP_effort(LUTP):
    ...
    effort = 0.0
    for i in range(len(quainpin_code)):
        effort += quanpin_code_effort_table[quainpin_code[i]] * quanpin_code_frequency_table[quanpin_code[i]]
